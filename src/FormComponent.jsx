...
const FormComponent = ({ user, onInputChange, onSubmit, onCancel }) => {
  return (
    <form
      onSubmit={onSubmit}
      className="max-w-3xl mx-auto p-4 bg-white/30 rounded-lg shadow-lg space-y-6"
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
        ...
        <PasswordInput value={user.Password} onChange={onInputChange} />
      ...
      <Button isEditing={user.isEditing} handleCancel={onCancel} />
    </form>
  );
};
